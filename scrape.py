...
def extract_specialization_data(url):
    ...
    subpages3 = soup.text.split('<h4 class="css-6ecy9b">Skills you')
    course_skills = []
    for page3 in subpages3[1:]:
    ...
    for i in range(min(len(course_info), len(course_skills))):
        course_info[i]['Skills'] = course_skills[i]
